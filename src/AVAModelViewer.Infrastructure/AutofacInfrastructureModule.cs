...
using Autofac;
using AVAModelViewer.Core.ContributorAggregate;
using AVAModelViewer.Core.Interfaces;
using AVAModelViewer.Infrastructure.Data;
using AVAModelViewer.Infrastructure.Data.Queries;
using AVAModelViewer.Infrastructure.Email;
using AVAModelViewer.UseCases.Contributors.Create;
using AVAModelViewer.UseCases.Contributors.List;
using MediatR;
using MediatR.Pipeline;
using Module = Autofac.Module;

namespace AVAModelViewer.Infrastructure;
